module github.com/kotovmak/go-admin-core/sdk
...
require (
	...
	github.com/kotovmak/go-admin-core v1.3.12-0.20221121065133-27b7dbe27a8f
	github.com/kotovmak/go-admin-core/plugins/logger/zap v0.0.0-20210610020726-2db73adb505d
